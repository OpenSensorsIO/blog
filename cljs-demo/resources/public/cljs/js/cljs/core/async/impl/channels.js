...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t15900 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t15900 = (function (val,box,meta15901){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t15900.cljs$lang$type = true;
cljs.core.async.impl.channels.t15900.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t15900";
cljs.core.async.impl.channels.t15900.cljs$lang$ctorPrWriter = (function (this__4010__auto__,writer__4011__auto__,opt__4012__auto__){return cljs.core._write.call(null,writer__4011__auto__,"cljs.core.async.impl.channels/t15900");
});
cljs.core.async.impl.channels.t15900.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t15900.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_15902){var self__ = this;
var _15902__$1 = this;return self__.meta15901;
});
cljs.core.async.impl.channels.t15900.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_15902,meta15901__$1){var self__ = this;
var _15902__$1 = this;return (new cljs.core.async.impl.channels.t15900(self__.val,self__.box,meta15901__$1));
});
cljs.core.async.impl.channels.__GT_t15900 = (function __GT_t15900(val__$1,box__$1,meta15901){return (new cljs.core.async.impl.channels.t15900(val__$1,box__$1,meta15901));
});
}
return (new cljs.core.async.impl.channels.t15900(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_15903 = self__.takes.pop();if((taker_15903 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_15903))
{var take_cb_15904 = cljs.core.async.impl.protocols.commit.call(null,taker_15903);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_15904,taker_15903){
return (function (){return take_cb_15904.call(null,null);
});})(take_cb_15904,taker_15903))
);
} else
{}
{
