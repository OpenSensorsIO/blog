...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_15859 = 0;while(true){
...
{var i_15866 = (self__.level + 1);while(true){
if((i_15866 <= (new_level + 1)))
{(update[i_15866] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_15868 = 0;while(true){
if((i_15868 <= self__.level))
{var links_15869 = (update[i_15868]).forward;if(((links_15869[i_15868]) === x__$1))
{(links_15869[i_15868] = (x__$1.forward[i_15868]));
{
