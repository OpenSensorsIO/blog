...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_15894 = 0;while(true){
var m_15895 = cljs.core.async.impl.dispatch.tasks.pop();if((m_15895 == null))
{} else
{m_15895.call(null);
if((count_15894 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__15896 = (count_15894 + 1);
count_15894 = G__15896;
continue;
}
} else
{}
