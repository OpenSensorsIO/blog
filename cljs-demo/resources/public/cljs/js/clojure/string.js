...
{{
var G__13111 = cljs.core.pop.call(null,v__$1);
v__$1 = G__13111;
continue;
}
} else
...
{var pred__13115 = cljs.core._EQ_;var expr__13116 = limit;if(cljs.core.truth_(pred__13115.call(null,1,expr__13116)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__13115.call(null,2,expr__13116)))
...
{var ch = s.charAt(index);var temp__4090__auto___13122 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___13122))
{var replacement_13123 = temp__4090__auto___13122;buffer.append([cljs.core.str(replacement_13123)].join(''));
} else
{buffer.append(ch);
}
{
var G__13124 = (index + 1);
index = G__13124;
continue;
}
}
