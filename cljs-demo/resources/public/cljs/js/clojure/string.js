...
{{
var G__16356 = cljs.core.pop.call(null,v__$1);
v__$1 = G__16356;
continue;
}
} else
...
{var pred__16360 = cljs.core._EQ_;var expr__16361 = limit;if(cljs.core.truth_(pred__16360.call(null,1,expr__16361)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__16360.call(null,2,expr__16361)))
...
var G__16363 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__16364 = (limit__$1 - 1);
var G__16365 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__16363;
limit__$1 = G__16364;
parts = G__16365;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___16367 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___16367))
{var replacement_16368 = temp__4090__auto___16367;buffer.append([cljs.core.str(replacement_16368)].join(''));
} else
{buffer.append(ch);
}
{
var G__16369 = (index + 1);
index = G__16369;
continue;
}
}
