...
{var name_str = cljs.core.name.call(null,dashed);var vec__10133 = clojure.string.split.call(null,name_str,/-/);var start = cljs.core.nth.call(null,vec__10133,0,null);var parts = cljs.core.nthnext.call(null,vec__10133,1);if(cljs.core.truth_(reagent.impl.util.dont_camel_case.call(null,start)))
{return name_str;
} else
...
var G__10135__delegate = function (self__,a){var self____$1 = this;var _ = self____$1;var or__3443__auto___10136 = self__.p;if(cljs.core.truth_(or__3443__auto___10136))
{} else
...
return G__10135__delegate.call(this,self__,a);};
G__10135.cljs$lang$maxFixedArity = 1;
G__10135.cljs$lang$applyTo = (function (arglist__10137){
var self__ = cljs.core.first(arglist__10137);
var a = cljs.core.rest(arglist__10137);
return G__10135__delegate(self__,a);
});
G__10135.cljs$core$IFn$_invoke$arity$variadic = G__10135__delegate;
return G__10135;
})()
;
reagent.impl.util.partial_ifn.prototype.apply = (function (self__,args10134){var self__ = this;
...
var G__10138__delegate = function (a){var _ = this;var or__3443__auto___10139 = self__.p;if(cljs.core.truth_(or__3443__auto___10139))
{} else
{self__.p = cljs.core.apply.call(null,cljs.core.partial,self__.f,self__.args);
}
return cljs.core.apply.call(null,self__.p,a);
...
return G__10138__delegate.call(this,a);};
G__10138.cljs$lang$maxFixedArity = 0;
G__10138.cljs$lang$applyTo = (function (arglist__10140){
var a = cljs.core.seq(arglist__10140);
return G__10138__delegate(a);
});
...
{var bit__4093__auto__ = (G__10144.cljs$lang$protocol_mask$partition1$ & 256);if((bit__4093__auto__) || (G__10144.cljs$core$IMultiFn$))
{return true;
} else
{if((!G__10144.cljs$lang$protocol_mask$partition1$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IMultiFn,G__10144);
} else
{return false;
}
}
...
reagent.impl.util._not_found = (function (){var obj10146 = {};return obj10146;
})();
