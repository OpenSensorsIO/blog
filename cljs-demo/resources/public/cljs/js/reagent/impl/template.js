...
{return (function() { 
var G__10161__delegate = function (args){return cljs.core.apply.call(null,v,args);
};
...
{return cljs.core.reduce_kv.call(null,(function (res,k,v){var G__10164 = res;(G__10164[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.to_js_val.call(null,v));
return G__10164;
}),{},val);
} else
...
reagent.impl.template.set_id_class = (function set_id_class(props,p__10165){var vec__10167 = p__10165;var id = cljs.core.nth.call(null,vec__10167,0,null);var class$ = cljs.core.nth.call(null,vec__10167,1,null);var pid = (props["id"]);(props["id"] = ((!((pid == null)))?pid:id));
if((class$ == null))
{return null;
} else
...
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{var objprops = cljs.core.reduce_kv.call(null,(function (o,k,v){var pname_10168 = reagent.impl.template.cached_prop_name.call(null,k);if(!((pname_10168 === "key")))
{(o[pname_10168] = reagent.impl.template.convert_prop_value.call(null,v));
} else
{}
return o;
...
var G__10171 = jsprops;(G__10171["defaultValue"] = value);
(G__10171["value"] = null);
(G__10171["onChange"] = (function (p1__10169_SHARP_){return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__10169_SHARP_);
}));
return G__10171;
}
});
...
reagent.impl.template.add_input_methods = (function add_input_methods(spec){var G__10173 = spec;(G__10173["componentDidUpdate"] = (function (){var C = this;return reagent.impl.template.input_did_update.call(null,C);
}));
(G__10173["componentWillUnmount"] = (function (){var C = this;return reagent.impl.batching.dispose.call(null,C);
}));
return G__10173;
});
...
return (function (p1__10174_SHARP_,p2__10175_SHARP_){var C = this;return reagent.impl.template.wrapped_should_update.call(null,C,p1__10174_SHARP_,p2__10175_SHARP_);
...
reagent.impl.template.parse_tag = (function parse_tag(hiccup_tag){var vec__10177 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));var tag = cljs.core.nth.call(null,vec__10177,0,null);var id = cljs.core.nth.call(null,vec__10177,1,null);var class$ = cljs.core.nth.call(null,vec__10177,2,null);var comp = (reagent.impl.template.DOM[tag]);var class_SINGLEQUOTE_ = (cljs.core.truth_(class$)?clojure.string.replace.call(null,class$,/\./," "):null);if(cljs.core.truth_(comp))
{} else
...
reagent.impl.template.get_wrapper = (function get_wrapper(tag){var vec__10179 = reagent.impl.template.parse_tag.call(null,tag);var comp = cljs.core.nth.call(null,vec__10179,0,null);var id_class = cljs.core.nth.call(null,vec__10179,1,null);return reagent.impl.template.wrap_component.call(null,comp,id_class,[cljs.core.str(tag)].join(''));
});
...
var c = reagent.impl.template.as_class.call(null,cljs.core.nth.call(null,v,0));var jsprops = (function (){var obj10183 = {};(obj10183[reagent.impl.util.cljs_argv] = v);
(obj10183[reagent.impl.util.cljs_level] = level);
return obj10183;
})();var k_10184 = reagent.impl.template.get_key.call(null,cljs.core.meta.call(null,v));var k_SINGLEQUOTE__10185 = (((k_10184 == null))?reagent.impl.template.get_key.call(null,cljs.core.nth.call(null,v,1,null)):k_10184);if((k_SINGLEQUOTE__10185 == null))
{} else
{(jsprops["key"] = k_SINGLEQUOTE__10185);
}
...
reagent.impl.template.expand_seq = (function expand_seq(s,level){var a = cljs.core.into_array.call(null,s);var level_SINGLEQUOTE_ = (level + 1);var n__4291__auto___10186 = a.length;var i_10187 = 0;while(true){
if((i_10187 < n__4291__auto___10186))
{(a[i_10187] = reagent.impl.template.as_component.call(null,(a[i_10187]),level_SINGLEQUOTE_));
{
...
reagent.impl.template.convert_args = (function convert_args(argv,first_child,level){var a = cljs.core.into_array.call(null,argv);var n__4291__auto___10189 = a.length;var i_10190 = 0;while(true){
if((i_10190 < n__4291__auto___10189))
{if((i_10190 >= first_child))
{(a[i_10190] = reagent.impl.template.as_component.call(null,(a[i_10190]),level));
} else
{}
{
