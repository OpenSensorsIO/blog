...
{var C_10114 = (a[i]);if(cljs.core.truth_(C_10114.cljsIsDirty))
{C_10114.forceUpdate();
} else
{}
{
...
reagent.impl.batching.dispose = (function dispose(C){var ratom_10116 = C.cljsRatom;if(!((ratom_10116 == null)))
{reagent.ratom.dispose_BANG_.call(null,ratom_10116);
} else
{}
